          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="relative z-50 flex flex-shrink-0 items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3.5 border-b border-[#c9a84c]/15 bg-[#060914]/90 backdrop-blur-md">
                  ...
                  <div className="flex items-center gap-2.5 sm:gap-4">
                    ...
                    <div className="flex flex-col justify-center">
                      <div className="text-white font-heading font-bold text-sm sm:text-base tracking-wide leading-tight">Pavilion Square</div>
                ...
                {/* ── Main Viewer Area ── */}
                <div className="relative flex-1 w-full h-full bg-[#060914] overflow-hidden">
