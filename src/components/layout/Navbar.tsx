        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-[auto_1fr_auto] lg:grid-cols-[1fr_auto_1fr] items-center h-14 sm:h-16 md:h-20">
          ...
          <div className="flex justify-start">
            <a href="#hero" onClick={() => setActiveSection("hero")} className="flex items-center gap-4 group relative z-50">
              {/* Beautiful dark shadow base for logo visibility on bright images */}
              <div className="absolute inset-[0%] bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0.85)_0%,_rgba(0,0,0,0)_70%)] scale-[2] blur-[4px] mix-blend-multiply opacity-90 z-0 pointer-events-none" />
              <div className="absolute inset-[0%] bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0.6)_0%,_rgba(0,0,0,0)_60%)] scale-[1.5] blur-[12px] opacity-100 z-0 pointer-events-none" />

              <div className="relative h-12 w-auto sm:h-14 md:h-16 flex items-center justify-center transition-transform duration-500 group-hover:scale-105 z-10 px-2">
                <img
