...
function FloatingIcon({ icon: Icon, text, link, isPrimary = false }: { icon: any, text: string, link: string, isPrimary?: boolean }) {
    ...
    return (
        <div className="relative flex items-center justify-center group/wrapper">
            ...
            {isPrimary && (
                <>
                    <div className="absolute inset-0 rounded-full bg-[#ffd700]/10 blur-md animate-pulse pointer-events-none" />
                    <div className="absolute inset-0 rounded-full border border-[#ffd700]/40 opacity-0 animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite] pointer-events-none" style={{ animationDelay: '1s' }} />
                    <div className="absolute inset-0 rounded-full border border-[#c9a84c]/20 opacity-0 animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite] pointer-events-none" />
                </>
            )}
            ...
            >
                ...
                <span className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#c9a84c]/0 via-[#c9a84c]/5 to-[#ffd700]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
